<template>
    <el-form label-width="100px" `>
        ...
        <el-form-item label="重量(g)">
            <el-input placeholder="SKU价格(元)" type="number" v-model="skuParams.weight"></el-input>
        </el-form-item>
        ...
        <el-form-item label="销售属性">
            <el-form :inline="true">
                <el-form-item v-for="(item, index) in saleAttrArr" :key="item.id" :label="item.saleAttrName">
